...
import { useCreateMomentMutation } from '../../../redux/features/momentOfSunrise/momentOfSunriseApi';
const CreateMoment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await createMoment(formData).unwrap();

      if (res?.success) {
        toast.success(res?.message);
        navigate('/dashboard/all-moment');
      }
    } catch (error) {
      console.log(error);
    }
