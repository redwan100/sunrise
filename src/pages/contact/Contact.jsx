          ...
          <div className="grid gap-10 md:gap-6 md:grid-cols-[1fr_2fr]">
            <div className="space-y-3 p-4 rounded-md bg-gradient-to-tr from-pink-100 to-violet-100">
              <p>
                ...
                <span className="text-gray-600 ml-1">Banani, Dhaka Bangladesh</span>
              </p>
              <p>
            ...
            <div className=" space-y-4 bg-gray-200 p-4 rounded-md">
              ...
              <div>
                <textarea
                  ...
                  className="w-full rounded-md px-2  py-2 bg-slate-500 text-gray-100 placeholder:text-gray-100 focus:outline-offset-2 outline-slate-600 "></textarea>
              </div>
