    ...
    <div className="my-20">
      <motion.div className="w-full my-container grid items-center md:grid-cols-2 gap-8">
        <motion.div
          ...
          className=""
        >
          <img src={womenEdu} alt="women education" className="max-w-full rounded-md" />
        </motion.div>
        <motion.div
          initial={{
            translateX: -100,
        ...
        >
          <h1 className="text-2xl xl:text-3xl  font-semibold text-lime-900 text-center">
            WASH is a top priority for <span className=" text-lime-950">SUNRISE</span>
          </h1>
          <p className="text-sm sm:text-base text-lime-900 text-justify ">
            The extensive reach of TMSS across all of the nations has created a wealth of
            opportunity for TMSS to work in this crucial sector. Currently, TMSS is carrying out a
            number of activities on its own initiative and with the assistance of other donor
            organizations to ensure the access to safe water, sanitary facilities, and hygienic
